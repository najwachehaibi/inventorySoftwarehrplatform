...
namespace InventoryBeginners.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public IActionResult Create(Category item)
        {
            ...
            {
                TempData["SuccessMessage"] = "Category " + item.Name + " Created Successfully";
        ...
        public IActionResult Edit(Category item)
        {
            ...
            try
            {
                ...
                if (errMessage == "")
                {
                    ...
                    TempData["SuccessMessage"] = item.Name + ", Category Saved Successfully";
                    bolret = true;
                }
            }
            catch (Exception ex)
        ...
        public IActionResult Delete(Category item)
        {
            ...
            TempData["SuccessMessage"] = "Category " + item.Name + " Deleted Successfully";
            return RedirectToAction(nameof(Index), new { pg = currentPage });
